    ...
    <section className="py-20 sm:py-24">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-gray-600 mt-4">Select your role to begin...</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center max-w-3xl mx-auto">
          ...
          <Card className="border rounded-xl hover:shadow-lg transition-shadow">
            <CardContent className="flex flex-col gap-4 p-6 text-center">
              ...
              <p className="text-gray-600">Cast your vote securely and make your voice heard in democratic elections.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border rounded-xl hover:shadow-lg transition-shadow">
            <CardContent className="flex flex-col gap-4 p-6 text-center">
              ...
              <p className="text-gray-600">Run for office and present your vision to the voters in your community.</p>
            </CardContent>
          </Card>
        </div>
      </div>
